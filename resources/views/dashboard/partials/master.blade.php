    ...
    <div class="position-fixed bottom-0 start-0 p-3 " style="z-index: 1090">
        <div id="kt_docs_toast_toggle" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
            <div class="toast-header">
                <img src="{{ asset('placeholder_images/favicon_E7kky.svg') }}" class="me-2 theme-light-show"
                    width="20" srcset="">
                <img src="{{ asset('placeholder_images/favicon_E7kky.svg') }}" class="me-2 theme-dark-show"
                    width="20" srcset="">
