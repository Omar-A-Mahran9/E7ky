  ...
  <tr>
    <td style="padding-right: 0px;padding-left: 0px;" align="center">
      <a href="https://unlayer.com" target="_blank">
        <img align="center" border="0" src="{{URL::asset('placeholder_images/logo.svg')}}" alt="Logo" title="Logo" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 20%;max-width: 150px;" width="150" class="v-src-width v-src-max-width"/>
      </a>
    </td>
  </tr>
</table>
...
<table style="font-family:'Lato',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="font-size: 14px; color: #333333; line-height: 190%; text-align: left; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 190%; text-align: center;"><span style="font-size: 22px; line-height: 41.8px;"><strong>{{ $user->otp }}</strong></span></p>
  </div>
...
<p style="font-size: 14px; line-height: 190%;"><span style="font-size: 16px; line-height: 30.4px;"><strong>[Platin]</strong></span></p>
  </div>
