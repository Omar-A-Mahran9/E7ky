                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    style="padding:0;Margin:0;font-size:0"><img
                                                                        src="https://ehgddbk.stripocdn.email/content/guids/CABINET_075c7f10d52386032d3ab52bbef3e7ee7fe8439a755634678c5cc424dbf31bf4/images/logo.png"
                                                                        alt="" width="122"
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <img src="https://ehgddbk.stripocdn.email/content/guids/CABINET_a3448362093fd4087f87ff42df4565c1/images/78501618239341906.png"
                                                                        alt=""
                                                                        style="display:block;font-size:14px;border:0;outline:none;text-decoration:none"
                                                                        width="100">
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td align="center" class="es-m-txt-c"
                                                                    ...
                                                                    <h1
                                                                        ...
                                                                        {{ __('Your email has been verified') }}</h1>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="center" class="es-m-p0r es-m-p0l"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        {{ __('We will keep you updated with the latest novelties, discounts, sales, new and seasonal collections, as well as events and news!') }}
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center" class="es-m-txt-c"
                                                                    style="padding:0;Margin:0;padding-right:20px;padding-left:20px;padding-top:20px">
                                                                    <h3
                                                                        style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:normal;line-height:28px;color:#333333">
                                                                        {{ __('Please click the link below to set your new password.') }}
                                                                    </h3>
                                                                </td>
                                                            </tr>
                                                            <tr>
