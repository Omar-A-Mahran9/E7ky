    ...
    public function rules()
    {
        $blog = request()->route('blog');
         return [
            ...
            "name_ar" => ["required", "string:255", "unique:brands,name_ar,$blog->id", new NotNumbersOnly()],
            "name_en" => ["required", "string:255", "unique:brands,name_en,$blog->id", new NotNumbersOnly()],
